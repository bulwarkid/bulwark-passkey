...
wails build -s -skipbindings -platform darwin/universal -debug
...
codesign --force --deep --sign "$APP_CERTIFICATE_NAME" --options=runtime --entitlements "$CONFIG_DIR/app.entitlements" --timestamp=none --verbose --generate-entitlement-der "$APP_PATH"
cd ..
